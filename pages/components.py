    ...
    for component_slug, component in components.items():
        ...
        with component_cols[col_ix]:
            ...
            with st_yled.container(
                ...
                with st_yled.container(height=110, padding="0px", padding_left = "8px", border_width="0px"):

                    st_yled.subheader(component.name, font_size="20px")
                    st_yled.markdown(component.preview_description, font_size="12px", font_weight="500")
