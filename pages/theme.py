...
def theme_color_picker(theme_property: str, default_hex_value: str, label: str, label_font_size: str = '20px', label_field_width: int = 140):
...
with tab_color:
    ...
    frame_type = st_yled.radio("Frame Type", options=[":material/width_full: Main", ":material/side_navigation: Sidebar"], key="theme-frame-type", horizontal=True, label_visibility="collapsed", font_size='14px')
    ...
    with col1.container(key="color-selectors"):
        ...
        theme_color_picker("primaryColor", uiconfig.PRIMARY_COLOR_DEFAULT, "Primary")

        theme_color_picker("backgroundColor", uiconfig.BACKGROUND_COLOR_DEFAULT, "Background")

        theme_color_picker("secondaryBackgroundColor", uiconfig.SECONDARY_BACKGROUND_COLOR_DEFAULT, "Secondary Background")

        theme_color_picker("textColor", uiconfig.TEXT_COLOR_DEFAULT, "Text")
    ...
    with col2:
        ...
        with st_yled.container(
            key="color-preview",
            height=400,
            background_color=st.session_state['theme-backgroundColor'],
            border = True
        ):
            ...
            with st_yled.container(
                ...
                background_color=st.session_state['theme-primaryColor'],
                height=128,
                width=112
            ):
            ...
            with st.container(horizontal=True, horizontal_alignment="right"):
                ...
                with st_yled.container(
                    ...
                    background_color=st.session_state['theme-secondaryBackgroundColor'],
                    height=112,
                    width=112,
                    horizontal=True,
                    horizontal_alignment="right"
            ...
            st_yled.markdown("Textcolor",
                            ...
                            color=st.session_state['theme-textColor'] )
    ...
    with st.expander("More Color Options"):
        ...
        with col1.container(key="color-ext-selectors"):
            ...
            theme_color_picker("linkColor", uiconfig.LINK_COLOR_DEFAULT, "Link", label_font_size='16px', label_field_width=100)

            theme_color_picker("borderColor", uiconfig.BORDER_COLOR_DEFAULT, "Border", label_font_size='16px', label_field_width=100)

            theme_color_picker("dataframeHeaderBackgroundColor", uiconfig.DATAFRAME_HEADER_BG_COLOR_DEFAULT, "DataFrame Header", label_font_size='16px', label_field_width=100)

            theme_color_picker("dataframeBorderColor", uiconfig.DATAFRAME_BORDER_COLOR_DEFAULT, "DataFrame Border", label_font_size='16px', label_field_width=100)

            theme_color_picker("codeBackgroundColor", uiconfig.CODE_BG_COLOR_DEFAULT, "Code Background", label_font_size='16px', label_field_width=100)
        ...
        with col2:
            ...
            with st_yled.container(
                ...
                st_yled.markdown("[Link Color](https://www.google.com)",
                                color=st.session_state['theme-linkColor'],
                ...
                with st_yled.container(border_width='3px',
                                        border_style='solid',
                                        border_color=st.session_state['theme-borderColor'],
                ...
                with st_yled.container(background_color=st.session_state['theme-dataframeHeaderBackgroundColor'],
                ...
                with st_yled.container(key="dataframe-border-color-preview",
                                        border_width='3px',
                                        border_style='solid',
                                        border_color=st.session_state['theme-dataframeBorderColor'],):

                    st_yled.markdown("**Dataframe Border**", key="dataframe-border-color-preview-text")

                st.write("")

                st_yled.code("# Code Background\nprint(\"Hello\")", background_color=st.session_state['theme-codeBackgroundColor'],)